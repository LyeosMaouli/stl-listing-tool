...
GETTING STARTED:
1. Drag and drop STL files or folders into the drop area
2. Or use "Browse Files..." or "Browse Folder..." buttons
3. Configure processing options in the Analysis/Validation/Rendering tabs
